...
public class ResultadoRecyclerAdapter3 extends RecyclerView.Adapter<ResultadoRecyclerAdapter3.ViewHolder> {
    List<Resultado> resultados;

    public ResultadoRecyclerAdapter3(List<Resultado> resultados){
    ...
    @NonNull
    @Override
    public ResultadoRecyclerAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.linha_resultados_tabbed1, parent, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ResultadoRecyclerAdapter3.ViewHolder holder, int position) {
